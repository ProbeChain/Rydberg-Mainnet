...
// ProtocolLengths includes SLP messages (0x20-0x27) requiring 0x28 = 40 total codes.
var ProtocolLengths = map[uint]uint64{lpv2: 22, lpv3: 40, lpv4: 40}
...
const (
	...
	// SmartLight Protocol (SLP) messages — extend LES for SmartLight nodes.
	// SmartLight nodes are lightweight behavior contributors that send ACKs,
	// heartbeats, GNSS time samples, and execute agent tasks.
