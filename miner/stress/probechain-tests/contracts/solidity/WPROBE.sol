...
contract WPROBE {
    string public name = "Wrapped PROBE";
    string public symbol = "WPROBE";
    ...
    function withdraw(uint wad) public { require(balanceOf[msg.sender] >= wad); balanceOf[msg.sender] -= wad; (bool ok,) = msg.sender.call{value: wad}(""); require(ok); emit Withdrawal(msg.sender, wad); }
    ...
    function transferFrom(address src, address dst, uint wad) public returns (bool) {
        ...
        balanceOf[src] -= wad; balanceOf[dst] += wad; emit Transfer(src, dst, wad); return true;
    }
}
